var WebDialog = function()
{
    ...
    this.Text = null;
    this.Container = null;
    this.ImagePath = "http://jybox.net/images/dialog/";
    this.posX = 0;
    this.posY = 0;
    this.IsDown = false;
    this.Width = 300;
    ...
    this.ButtonCancel.className = "WebDialog_commandButton";
